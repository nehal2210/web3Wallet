        ...
        <div className="fixed z-10 top-0 right-0 bottom-0 left-0 w-full h-[100vh] bg-bgColor2 bg-opacity-50 flex flex-col pt-5 items-center">
            ...
            <div className="w-[22%] h-[65%] pb- bg-primary mt-5 border border-white rounded-lg z-40">
                ...
                <div className="  w-full ">
                    <p className="text-heading text-2xl text-center cursor-pointer ">Show Private key</p>
                </div>
                <div className="flex flex-col justify-center items-center ">
                    ...
                    <div className="flex w-full justify-center py-3 cursor-pointer">
                        <span className="text-white">Account 2</span> <span className=" px-4 text-btnColor py-1"><AiFillEdit /></span>
                    </div>
                </div>
                {
                    showPrivateKey ?
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <div className=" w-full px-4 py-3 cursor-pointer">
                                <span className="text-white">private key for</span> <span className="text-btnColor  ">Account 2</span>
                            </div>
                            <div className="bg-bgColor  h-[50px] w-[90%]   mt-3 flex justify-between rounded-md items-center px-3">
                                <span className="text-white cursor-pointer ">dfseudfiey78fy7f78sdyc78tzxc7yc78tzxc7</span>
                        ...
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <div className="border border-white p-2 mt-5 flex justify-center rounded-md items-center">
                                <p className="text-white cursor-pointer">dfseudfiey78fy7f78sdyc78tzxddac</p>
                                <BiSolidCopy className="text-btnColor mx-2 cursor-pointer" />
                            </div>
                            <div className="flex items-center justify-center ">
